 ...
 *
 * RunBB Cache class
 * Usage : $cache = new \RunBB\Cache(array('name' => , 'path' =>, 'extension' =>));
 */
...
class Cache
{
     ...
     * Decrement key
     * @return object
     * @throws RunBBException for cache key decrement.
     */
    public function decrement($key)
    {
        ...
        throw new RunBBException("Error: decrement() - Key '{$key}' not found.");
    }
