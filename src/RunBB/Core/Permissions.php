...
class Permissions
{
    ...
    public function delParent($gid = null, $parent = null)
    {
        ...
        if (($key = array_search($parent, $this->parents[$gid])) !== false) {
            ...
            throw new RunBBException('Internal error : Group '.$parent.' is not a parent of group '.$gid, 500);
        }
        return $this;
    }
    ...
    public function allowUser($user = null, $permission = null)
    {
        ...
        if (!isset($this->permissions[$gid][$uid][$permission])) {
            ...
            if ($result) {
                ...
                throw new RunBBException('Internal error : Unable to add new permission to user', 500);
            }
        }
        return $this;
    }
