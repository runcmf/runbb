...
//        translate('misc');
    ...
    public function index($req, $res, $args)
    {
        ...
        View::setPageInfo([
                'title' => [Utils::escape(ForumSettings::get('o_board_title')), __('PMS', 'private_messages'), $this->inboxes[$args['inbox_id']]['name']],
                'admin_console' => true,
        ...
        if (Request::isPost()) {
            ...
            if (Input::post('preview')) {
                ...
                if (!$conv) {
                    ...
                    } elseif (ForumSettings::get('p_subject_all_caps')['p_subject_all_caps'] == '0' && Utils::is_all_uppercase($data['subject']) && !User::get()->is_admmod) {
                ...
                if ($args['tid']) {
                    ...
                    if ($conv) {
                        ...
                        if ($msg_id = $this->model->addMessage($msg_data, $args['tid'], [$user->id, User::get()->id])) {
    ...
    public function show($req, $res, $args)
    {
        ...
        View::setPageInfo([
                'title' => [Utils::escape(ForumSettings::get('o_board_title')), __('PMS', 'private_messages'), $this->model->getUserFolders(User::get()->id)[$conv['folder_id']]['name'], Utils::escape($conv['subject'])],
                'admin_console' => true,
                'paging_links' => $paging_links,
    ...
    public function blocked($req, $res, $args)
    {
        ...
        View::setPageInfo([
                'title' => [Utils::escape(ForumSettings::get('o_board_title')), __('PMS', 'private_messages'), __('Blocked Users', 'private_messages')],
                'admin_console' => true,
                'errors' => $errors,
                'username' => $username,
