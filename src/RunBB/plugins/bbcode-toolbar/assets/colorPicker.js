    ...
    b.prototype = {
        g: function () {
            if (this.r) {
                ...
                if (b[a].className == "hexbox") {
                    this.a = b[a];
                } else if (b[a].className == "bgbox") {
                    this.b = b[a];
                } else if (b[a].className == "colorbox") {
                    this.c = b[a];
                }
        ...
        h: function (a) {
            if (this.a) {
                this.a.innerHTML = a.title ? a.title : a.style.backgroundColor;
            }
            if (this.b) {
                this.b.style.backgroundColor = a.style.backgroundColor
            }
        },
        j: function () {
            var a = this;
        ...
        k: function (c, b, f) {
            ...
            if (a.nodeName == "B") {
                if (b.b) {
                    b.b.style.backgroundColor = a.style.backgroundColor;
                }
                if (b.a) {
                    b.a.innerHTML = a.title ? a.title : a.style.backgroundColor;
                }
                if (f) {
                    b.f = a;
