...
?>
            <div class="inform">
                <fieldset>
                    ...
                    <div class="infldset">
                        <p><?= __('Robot info')    ?></p>
                        <label class="required"><strong><?= sprintf(__('Robot question'), $question[$index_questions]) ?> <span><?= __('Required') ?></span></strong><br /><input name="captcha" id="captcha" type="text" size="10" maxlength="30" /><input name="captcha_q" value="<?= $qencoded ?>" type="hidden" /></label>
                    </div>
                </fieldset>
            </div>
