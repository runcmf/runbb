            ...
            <form id="censoring" method="post" action="<?= Router::pathFor('adminCensoring') ?>">
                ...
                <div class="inform">
                    <fieldset>
                        ...
                        <div class="infldset">
                            <p><?= __('Add word info'); echo (ForumSettings::get('o_censoring') == '1' ? sprintf(__('Censoring enabled'), '<a href="'.Router::pathFor('adminOptions').'#censoring">'.__('Options').'</a>') : sprintf(__('Censoring disabled'), '<a href="'.Router::pathFor('adminOptions').'#censoring">'.__('Options').'</a>')) ?></p>
                            <table>
                            <thead>
                                <tr>
