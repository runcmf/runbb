...
if ($active_page == 'index') {
    if (ForumSettings::get('o_feed_type') == '1') {
        echo "\t\t\t".'<p id="feedlinks"><span class="rss"><a href="'.Url::baseStatic().'/extern.php?action=feed&amp;type=rss">'.__('RSS active topics feed').'</a></span></p>'."\n";
    } elseif (ForumSettings::get('o_feed_type') == '2') {
        echo "\t\t\t".'<p id="feedlinks"><span class="atom"><a href="'.Url::baseStatic().'/extern.php?action=feed&amp;type=atom">'.__('Atom active topics feed').'</a></span></p>'."\n";
    }
} elseif ($active_page == 'Forum') {
    if (ForumSettings::get('o_feed_type') == '1') {
        echo "\t\t\t".'<p id="feedlinks"><span class="rss"><a href="'.Url::baseStatic().'/extern.php?action=feed&amp;fid='.$fid.'&amp;type=rss">'.__('RSS forum feed').'</a></span></p>'."\n";
    } elseif (ForumSettings::get('o_feed_type') == '2') {
        echo "\t\t\t".'<p id="feedlinks"><span class="atom"><a href="'.Url::baseStatic().'/extern.php?action=feed&amp;fid='.$fid.'&amp;type=atom">'.__('Atom forum feed').'</a></span></p>'."\n";
    }
} elseif ($active_page == 'Topic') {
    if (ForumSettings::get('o_feed_type') == '1') {
        echo "\t\t\t".'<p id="feedlinks"><span class="rss"><a href="'.Url::baseStatic().'/extern.php?action=feed&amp;tid='.$tid.'&amp;type=rss">'.__('RSS topic feed').'</a></span></p>'."\n";
    } elseif (ForumSettings::get('o_feed_type') == '2') {
        echo "\t\t\t".'<p id="feedlinks"><span class="atom"><a href="'.Url::baseStatic().'/extern.php?action=feed&amp;tid='.$tid.'&amp;type=atom">'.__('Atom topic feed').'</a></span></p>'."\n";
    }
}
