...
<div class="box">
    <div class="inbox">
        ...
        <p><code>[post=1]<?= __('Test post') ?>[/post]</code> <?= __('produces') ?> <samp><a href="<?= Router::pathFor('viewPost', ['pid' => '1']).'#1' ?>"><?= __('Test post') ?></a></samp></p>
        <p><code>[post]1[/post]</code> <?= __('produces') ?> <samp><a href="<?= Router::pathFor('viewPost', ['pid' => '1']).'#1' ?>"><?= Router::pathFor('viewPost', ['pid' => '1']).'#1' ?></a></samp></p>
...
<div class="box">
    <div class="inbox">
        ...
        <div class="postmsg">
            <div class="codebox"><pre><code class="hljs"><?= __('Code text') ?></code></pre></div>
        </div>
    </div>
</div>
