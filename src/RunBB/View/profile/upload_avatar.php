            ...
            <div class="inform">
                <fieldset>
                    ...
                    <div class="infldset">
                        ...
                        <p><?= __('Avatar desc'); echo ' '.ForumSettings::get('o_avatars_width').' x '.ForumSettings::get('o_avatars_height').' '.__('pixels').' '.__('and').' '.Utils::numberFormat(ForumSettings::get('o_avatars_size')).' '.__('bytes').' ('.Utils::fileSize(ForumSettings::get('o_avatars_size')).').' ?></p>
                    </div>
                </fieldset>
            </div>
