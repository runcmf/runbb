            ...
            <div class="inform">
                <fieldset>
                    ...
                    <div class="infldset">
                        ...
                        <label class="required"><strong><?= __('New email') ?> <span><?= __('Required') ?></span></strong><br /><input type="text" name="req_new_email" size="50" maxlength="80" /><br /></label>
                        <label class="required"><strong><?= __('Password') ?> <span><?= __('Required') ?></span></strong><br /><input type="password" name="req_password" size="16" /><br /></label>
