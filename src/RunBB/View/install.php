...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/style/themes/FeatherBB/style.css" />
</head>
                                    ...
                                    <div class="inform">
                                        <fieldset>
                                            ...
                                            <div class="infldset">
                                                ...
                                                <input type="text" name="install[db_host]" size="50" value="<?php echo $dbConfig['db_host'];?>" required />
                                            </div>
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="inform">
                                        <fieldset>
                                            ...
                                            <div class="infldset">
                                                ...
                                                <input type="text" name="install[db_name]" size="30" value="<?php echo $dbConfig['db_name'];?>" required />
                                            </div>
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="inform">
                                        <fieldset>
                                            ...
                                            <div class="infldset">
                                                ...
                                                <input type="text" name="install[db_user]" size="30" value="<?php echo $dbConfig['db_user'];?>" />
                                                <label class="conl"><?= __('Database password') ?></label>
                                                <input type="password" name="install[db_pass]" size="30" value="<?php echo $dbConfig['db_pass'];?>" />
                                    ...
                                    <div class="inform">
                                        <fieldset>
                                            ...
                                            <div class="infldset">
                                                ...
                                                <input type="text" name="install[db_prefix]" size="20" maxlength="30" value="<?php echo $dbConfig['db_prefix'];?>" />
                                            </div>
                                        </fieldset>
                                    </div>
